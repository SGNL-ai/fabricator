...
//
//	mockgen -source=pkg/generators/model/interfaces.go -destination=pkg/generators/model/mocks.go -package=model
//
...
func (mr *MockGraphInterfaceMockRecorder) createEntitiesFromYAML(yamlEntities any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEntityInterfaceMockRecorder) AddRow(row any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockEntityInterface) CheckKeyExists(keyValue string) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckKeyExists", keyValue)
	ret0, _ := ret[0].(bool)
	return ret0
}
...
func (mr *MockEntityInterfaceMockRecorder) CheckKeyExists(keyValue any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckKeyExists", reflect.TypeOf((*MockEntityInterface)(nil).CheckKeyExists), keyValue)
}
...
func (m *MockEntityInterface) GetRowByIndex(index int) *Row {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRowByIndex", index)
	ret0, _ := ret[0].(*Row)
	return ret0
}
...
func (mr *MockEntityInterfaceMockRecorder) GetRowByIndex(index any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRowByIndex", reflect.TypeOf((*MockEntityInterface)(nil).GetRowByIndex), index)
}
...
func (mr *MockEntityInterfaceMockRecorder) addRelationship(relationshipID, relationshipName, targetEntity, sourceExternalID, targetExternalID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEntityInterfaceMockRecorder) findAttributeByReference(reference any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEntityInterfaceMockRecorder) validateForeignKeyValue(attributeName, value any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAttributeInterfaceMockRecorder) setParentEntity(entity any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAttributeInterfaceMockRecorder) setRelationship(relatedEntityID, relatedAttributeName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
